...
<body class="min-h-screen flex flex-col justify-center items-center text-gray-300">
    ...
    <header class="fixed top-0 w-full bg-gradient-to-r from-blue-800 to-indigo-900 text-white px-4 py-3 flex justify-between items-center shadow-lg z-50">
        <h1 class="text-xl font-bold">UberMark</h1>
    ...
    <div class="glass w-full max-w-md mx-auto p-8 flex flex-col items-center shadow-2xl mt-20">
        ...
        <h2 class="text-2xl font-extrabold text-white mb-2 text-center">UberMark</h2>
        <p class="text-blue-200 mb-4 text-center text-sm">Compra en tus tiendas favoritas y recibe tus productos</p>
        ...
        <div class="w-full space-y-3 text-sm">
            <div class="bg-gray-800/50 p-3 rounded-lg flex items-center gap-3">
                ...
                <div>
                    <p class="font-bold text-white">Tiendas de conveniencia</p>
                    <p class="text-gray-400 text-xs">Productos del dia a dia en minutos</p>
                </div>
            </div>
            <div class="bg-gray-800/50 p-3 rounded-lg flex items-center gap-3">
                <span class="text-xl">🛍️</span>
                <div>
                    <p class="font-bold text-white">Supermercados</p>
                    <p class="text-gray-400 text-xs">Tu despensa completa a domicilio</p>
                </div>
            </div>
            <div class="bg-gray-800/50 p-3 rounded-lg flex items-center gap-3">
                <span class="text-xl">🍕</span>
                <div>
                    <p class="font-bold text-white">Restaurantes</p>
                    <p class="text-gray-400 text-xs">Comida de tus lugares favoritos</p>
                </div>
            </div>
        </div>
