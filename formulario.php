...
<head>
    ...
    <title>Formulario de Aplicación - Conductor Uber</title>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        echo "<div class='text-center p-4 mb-4 bg-green-500 text-white rounded-lg'>¡Aplicación enviada exitosamente!</div>";
    } else {
        echo "<div class='text-center p-4 mb-4 bg-red-500 text-white rounded-lg'>Error al enviar la aplicación: " . $stmt->error . "</div>";
    }
...
?>
    ...
    <div class="flex flex-col min-h-screen justify-center items-center px-4">
        <h1 class="text-4xl font-extrabold text-white mb-6 text-center">
            🚖 Formulario de Aplicación - <span class="text-blue-400">Conductor Uber</span>
        </h1>
        ...
        <form action="" method="POST" class="bg-gradient-to-r from-gray-800 via-gray-900 to-black p-6 rounded-lg shadow-lg w-full max-w-lg">
            <h2 class="text-2xl font-bold text-white mb-4 text-center">Información Personal</h2>
            ...
            <!-- Teléfono -->
            <div class="mb-4">
                <label for="phone" class="block text-sm font-medium text-gray-300 mb-2">Número de Teléfono</label>
                <input type="tel" name="phone" id="phone" placeholder="Ingresa tu número de teléfono" required class="w-full px-4 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white">
            </div>

            <!-- Correo Electrónico -->
            <div class="mb-4">
                <label for="email" class="block text-sm font-medium text-gray-300 mb-2">Correo Electrónico</label>
                <input type="email" name="email" id="email" placeholder="Ingresa tu correo electrónico" required class="w-full px-4 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white">
            </div>
            ...
            <!-- Año del Auto -->
            <div class="mb-4">
                <label for="car_year" class="block text-sm font-medium text-gray-300 mb-2">Año del Auto</label>
                <input type="number" name="car_year" id="car_year" placeholder="Ingresa el año del auto" required min="2000" class="w-full px-4 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white">
            </div>
            ...
            <div class="mb-4">
                <label for="trustworthy" class="block text-sm font-medium text-gray-300 mb-2">¿Por qué crees que serías un buen conductor de Uber?</label>
                <textarea name="trustworthy" id="trustworthy" placeholder="Escribe tu respuesta aquí" required class="w-full px-4 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white"></textarea>
            </div>

            <div class="mb-4">
                <label for="reliability" class="block text-sm font-medium text-gray-300 mb-2">¿Cómo describirías tu nivel de responsabilidad?</label>
                <textarea name="reliability" id="reliability" placeholder="Escribe tu respuesta aquí" required class="w-full px-4 py-2 border border-gray-600 rounded-lg bg-gray-800 text-white"></textarea>
            </div>
